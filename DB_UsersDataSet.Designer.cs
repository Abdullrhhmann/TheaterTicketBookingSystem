...
namespace LE_GRAND_REX_BETA {
    ...
    public partial class DB_UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class tbl_UsersDataTable : global::System.Data.TypedTableBase<tbl_UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tbl_UsersRow Addtbl_UsersRow(string Username, string Password, string FullName, string Email) {
...
namespace LE_GRAND_REX_BETA.DB_UsersDataSetTableAdapters {
    ...
    public partial class tbl_UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `tbl_Users` WHERE ((`Username` = ?) AND ((? = 1 AND `Password` IS NUL" +
                "L) OR (`Password` = ?)) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?))" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `tbl_Users` (`Username`, `Password`, `FullName`, `Email`) VALUES (?, " +
                "?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `tbl_Users` SET `Username` = ?, `Password` = ?, `FullName` = ?, `Email` = ? WHERE ((`Username` = ?) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LE_GRAND_REX_BETA.Properties.Settings.Default.DB_UsersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, [Password], FullName, Email FROM tbl_Users";
        ...
        public virtual int Delete(string Original_Username, string Original_Password, string Original_FullName, string Original_Email) {
        ...
        public virtual int Insert(string Username, string Password, string FullName, string Email) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, string FullName, string Email, string Original_Username, string Original_Password, string Original_FullName, string Original_Email) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string FullName, string Email, string Original_Username, string Original_Password, string Original_FullName, string Original_Email) {
            return this.Update(Original_Username, Password, FullName, Email, Original_Username, Original_Password, Original_FullName, Original_Email);
        }
    }
